      ...
      >
        <div className="row typ--center">
          <div className="col-12 col-12--tlg col-center">
            <h1 className="typ--bold mt7 mb5 my3--mlg mt3--mlg">The Redshift Holiday Cocktail Generator</h1>
            <img src="http://www.redshiftdigital.com/holiday2016/assets/img/empty_glasses.svg" />
            <h2 className="typ--bold my5 mt3--mlg mb0--mlg">Answer a few questions and we’ll find your perfect holiday tipple.</h2>
